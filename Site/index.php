    ...
    <header>
       <?php include_once(ROOT.'/SiteComponents/logotype.php');?>
            <div class="col-md-3 col-md-offset-2">
              ...
              <a href="#">Вход</a> | 
              <a href="/PhpSushiSite/reg">Регистрация</a>
              </div>
            </div>
        </div>
      </div>
...
height:0; \
	...
	";
            ...
            <ul class="main_menu_list" id="main_menu_list">
             ...
             <li><a href="/PhpSushiSite/menu">Наше меню</a></li>
             <li><a href="/PhpSushiSite/gallery">Фотогалерея</a></li>
             <li><a href="/PhpSushiSite/contacts">Контакты</a></li>
